...
const Localize = (() => {
  ...
  let map_it = {
    ...
    'buttonTitle': {
      ...
      'TRASH_SIGNI': 'Scarta',
      'USE_SPELL': 'Usa SPELL',
      'SPELL_EFFECT': 'Scegli che effetto attilete',
      'USE_ARTS': 'Usa ARTS',
      'ARTS_EFFECT': 'Scegli che effetto attilete',
      'SPELL_CUT_IN': 'Spell cut-in',
    ...
    DOM: {
      'index': {
        ...
        'proxy-title': 'Proxy',
        'proxy-description': 'Se la tua connessione a WEBXOSS non è stabile puoi prolete con l\'uso di un proxy.',
        'proxy-noproxy': 'No Proxy',
        'proxy-cloudflare': 'CloudFlare',
        'proxy-incapsula': 'Incapsula',
